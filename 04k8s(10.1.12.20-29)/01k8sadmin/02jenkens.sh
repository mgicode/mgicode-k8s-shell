...
#1 初始化
sed -i "s/10.1.12.129/10.1.12.62/g" /etc/sysconfig/network-scripts/ifcfg-ens160
...
-p 8080:8080 -p 50000:50000 -v /var/jenkins_home:/var/jenkins_home   10.1.12.61:5000/jenkins
